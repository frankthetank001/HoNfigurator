            ...
            if checks==True:
                ...
                if int(servertotal) < int(self.dataDict['svr_total']):
                    ...
                    for i in range (1,x+1):
                        ...
                        service_state = initialise.get_service(f"{self.dataDict['app_name']}{o}")
                        if playercount == 0:
                            if service_state:
                                if service_state['status'] == 'running':
                                    initialise.stop_service(self,f"{self.dataDict['app_name']}{o}",False)
                            initialise.stop_bot(self,f"{self.dataDict['app_name']}{o}.exe")
