...
if is_admin():
    ...
    class honfigurator():
        ...
        def popup_bonus():
            ...
            return True
        def regions(self):
            return [["US - West","US - East","Thailand","Australia","Malaysia","Russia","Europe","Brazil"],["USW","USE","SEA","AU","SEA","RU","EU","BR","NEWERTH"]]
        ...
        def creategui(self):
            ...
            #
            #   force proxy restart
            applet.Label(tab1, text="Restart Proxy\n(in next configure)",background=maincolor,foreground='white').grid(column=1, row=11,sticky="e",padx=[20,0])
