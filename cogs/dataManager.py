...
class mData():
    ...
    def returnDict_basic(self,svr_id):
        ...
        self.confDict_deployed.update({"sdc_home_dir":f"{self.confDict_deployed['hon_home_dir']}\\Documents\\Heroes of Newerth x64\\game\\logs\\adminbot{self.confDict_deployed['svr_id']}"})
